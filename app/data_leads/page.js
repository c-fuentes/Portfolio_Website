      ...
      <main className="flex flex-col gap-[32px] row-start-1 items-center justify-items-center">
          <div>
            ...
            <form action="/action_page.php" method="post">
                ...
                <input className="bg-white outline-black" type="text" id="fname" name="fname" placeholder="John" pattern="[A-Za-z]{20}" required autocomplete="on"></input><br></br>
                <label for="lname">Last name:</label><br></br>
                <input className="bg-white outline-black" type="text" id="lname" name="lname" placeholder="Doe"  pattern="[A-Za-z]{20}" required autocomplete="on"></input><br></br>
                ...
                <p>What kind(s) of insurance are you looking to get quoted for?</p>
                ...
                <input className="bg-red" type="submit" value="Submit" ></input>
            </form>
