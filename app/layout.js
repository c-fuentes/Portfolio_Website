...
export default function RootLayout({ children }) {
  return (
    <html lang="en">
      ...
      >
        <div className="grid grid-cols-2 md:grid-cols-4 text-lg gap-4 font-mono mt-4 flex-row justify-center"> 
          <div className="text-center border-4 border-double ml-2 flex-row justify-center">
            <Link href={"/"}> Home </Link>
          </div>
