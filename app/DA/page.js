...
export default function Home() {
  return (
    <div className="font-sans grid grid-rows-1 items-start justify-items-center min-h-screen p-8 gap-16 text-center inset-shadow-sm inset-shadow-blue-700 bg-blue-50">
      <main className="flex flex-col gap-[32px] row-start-1 items-center">
        ...
        <div id="NBA" className="grid gap-4">
        ...
        <div id="Electric" className="grid gap-4">
